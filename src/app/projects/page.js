...
const projects = [
  ...
  },
  {
    ...
    description: 'A modern, high-performance coaching dashboard built with React, Vite, and Supabase. Designed for fitness coaches to manage clients, track progress, and schedule sessions efficiently.',
    features: [
    ...
    techStack: ['React', 'Vite', 'Vanilla CSS', 'Supabase', 'React Router'],
